...
const (
	MonitorService_ParseProduct_FullMethodName = "/monitor.MonitorService/ParseProduct"
)
...
type MonitorServiceClient interface {
	ParseProduct(ctx context.Context, in *ParseProductRequest, opts ...grpc.CallOption) (*ParseProductResponse, error)
}
...
func (c *monitorServiceClient) ParseProduct(ctx context.Context, in *ParseProductRequest, opts ...grpc.CallOption) (*ParseProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ParseProductResponse)
	err := c.cc.Invoke(ctx, MonitorService_ParseProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MonitorServiceServer interface {
	ParseProduct(context.Context, *ParseProductRequest) (*ParseProductResponse, error)
...
func (UnimplementedMonitorServiceServer) ParseProduct(context.Context, *ParseProductRequest) (*ParseProductResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseProduct not implemented")
}
...
func _MonitorService_ParseProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitorServiceServer).ParseProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MonitorService_ParseProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitorServiceServer).ParseProduct(ctx, req.(*ParseProductRequest))
	}
...
var MonitorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ParseProduct",
			Handler:    _MonitorService_ParseProduct_Handler,
		},
	},
